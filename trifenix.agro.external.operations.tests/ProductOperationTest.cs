...
namespace trifenix.agro.external.operations.tests
{
    public class ProductOperationTest
    {
        ...
        public async Task SaveProduct_allParameters_success(string commercialName, string idActiveIngredient, string brand, string[] idDoses, MeasureType measureType, int quantity, KindOfProductContainer kindOfProduct) {
        ...
        public async Task SaveProduct_nullparameters_error(string commercialName, string idActiveIngredient, string brand, string[] idDoses, MeasureType measureType, int quantity, KindOfProductContainer kindOfProduct)
        {
