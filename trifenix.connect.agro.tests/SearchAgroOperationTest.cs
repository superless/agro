...
namespace trifenix.connect.agro.tests
{
    public class SearchAgroOperationTest
    {
        ...
        /// <summary>
        /// Verifica que las ids creadas de manera autom�tica en waiting harvest, se hayan asignado a cada waiting harvest 
        ...
        /// <summary>
        /// A�ade un producto al search, confirma los hash de cabecera y modelo.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Verifica que la consulta utilizada para borrar un entitySearch coincida correctamente con la operaci�n.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Elimina todas las dosis de un producto identificado, se verifica consulta de eliminaci�n.
        /// </summary>
        [Fact]
