...
namespace trifenix.connect.util
{
    ...
    public static partial class Mdm
    {
        ...
        public static partial class Reflection {
            ...
            /// <param name="Namespace">namespace donde se encuentra la clase que corresponde a la entidad</param>
            /// <returns>la clase que tiene el atributo BaseIndexAttribute y el índice indicado</returns>
            public static Type GetEntityType(int index, Type typeOfAssembly, string Namespace)
            {
                var assembly = Assembly.GetAssembly(typeOfAssembly);
                var modelTypes = GetLoadableTypes(assembly).Where(type => type.FullName.StartsWith(Namespace) && Attribute.IsDefined(type, typeof(EntityIndexAttribute)));
