...
namespace trifenix.agro.external.operations.entities
{
    public class OrderFolderOperations : IOrderFolderOperations
    {
        ...
        public async Task<ExtPostContainer<string>> SaveNewOrderFolder(string idPhenologicalEvent, string idApplicationTarget, 
            string categoryId, string idSpecie, string idIngredient)
        {
