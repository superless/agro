...
namespace trifenix.agro.external.operations
{
    ...
    public abstract class MainOperation<T, T_INPUT,T_GEO> : IValidatorAttributes<T_INPUT, T> where T : DocumentBase where T_INPUT : InputBase {
        ...
        public MainOperation(IMainGenericDb<T> repo, IExistElement existElement, IAgroSearch<T_GEO> search, ICommonDbOperations<T> commonDb, IValidator validator) {
            this.repo = repo;
