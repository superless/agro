...
namespace trifenix.agro.external.operations
{
    ...
    public class AgroManager<T> : IAgroManager<T> {
        ...
        /// Dosis
        /// </summary>
        public IGenericOperation<Dose, DosesInput> Dose => new DosesOperations<T>(GetMainDb<Dose>(), Search, GetCommonDbOp<Dose>(), CommonQueries, GetValidators<DosesInput, Dose>());
