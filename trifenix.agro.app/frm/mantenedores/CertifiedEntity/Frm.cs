...
namespace trifenix.agro.app.frm.mantenedores.certifiedentity
{
    public partial class Frm : Form, IFenixForm
    {
        ...
        public string GetEntityName() => Cloud.GetCosmosEntityName<CertifiedEntity>();

        public string FriendlyName() => "Entidad Certificadora";

        

        public void Edit(object obj)
        {
            var current = (CertifiedEntity)obj;
            
            Cloud.PushElement(new CertifiedEntityInput { Name = tbxName.Text, Id = current.Id, Abbreviation = tbxAbbreviation.Text }, entityName).Wait();
            
        }

        public void New()
        {
            Cloud.PushElement(new CertifiedEntityInput { Name = tbxName.Text, Abbreviation = tbxAbbreviation.Text }, entityName).Wait();
        ...
        public object GetList() => Cloud.GetElements<CertifiedEntity>(EntityRelated.CERTIFIED_ENTITY);

        public string Description() => new MdmDocs().GetInfoFromEntity((int)EntityRelated.CERTIFIED_ENTITY).Description;
